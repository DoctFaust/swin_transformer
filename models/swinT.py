...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, patch_size=4, in_chans=6, embed_dim=96, norm_layer=None):
        super().__init__()
...
def swin_small(nclass, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        ...
        pretrained_root = None
    model = SwinT(nclass, embed_dim=96, depths=[2, 2, 18, 2], window_size=8, aux=aux, head=head, edge_aux=edge_aux,
                  num_heads=[3, 6, 12, 24], head_dim=[96, 192, 384, 768], pretrained_root=pretrained_root)
...
def swin_base(nclass, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        ...
        pretrained_root = None
    model = SwinT(nclass, embed_dim=128, depths=[2, 2, 18, 2], window_size=8, aux=aux, head=head, edge_aux=edge_aux,
...
def swin_large(nclass, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        ...
        pretrained_root = None
    model = SwinT(nclass, embed_dim=192, depths=[2, 2, 18, 2], window_size=8, aux=aux, head=head, edge_aux=edge_aux,
