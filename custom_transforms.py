...
class RandomScaleCrop(object):
    ...
    def __call__(self, sample):
        ...
        short_size = short_size.astype(np.int32)
        h, w = img.shape[0:2]
        if h > w:
            ow = short_size[1]
            oh = int(1.0 * h * ow / w)
...
class ToTensor(object):
    ...
    def __init__(self, add_edge=True):
        ...
        self.normalize = transforms.Normalize((0.1342, 0.1767, 0.1026, 0.6252, -0.3050, 0.6057, 0.7089, 0.5417, 0.1167, 0.4118), (0.0017, 0.0017, 0.0020, 0.0321, 0.0227, 0.1355, 0.0181, 0.0150, 0.0006, 0.0065))
